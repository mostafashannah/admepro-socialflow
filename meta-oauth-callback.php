...
// Step 2: exchange for a long-lived access token (~60 days). This endpoint
// only works as GET with every param in the query string (including
// access_token) — POST always fails with a generic "object does not exist"
// error because Graph's router can't find access_token in the URL/query.
