...
function askPro(PDO $pdo, $senderName, $senderRole, $contextBlock, $userText, $senderId = null, $voiceTranscript = null, $fromPhone = null) {
    ...
    if (!$senderName) {
        ...
        $system = "You are Pro, the AI assistant built into SocialFlow. Today's date is " . date('Y-m-d') . " ("
                ...
                . "one\", etc.), never something to recap, repeat, or continue. Do not paste, restate, or append an "
                . "earlier answer (a table, a list, a report) into a new reply unless they explicitly ask for it "
                . "again — a totally unrelated new request (e.g. logging a payment) gets ONLY its own short answer, "
                . "nothing carried over from a previous topic. You can see this context about "
                . "them:\n\n{$contextBlock}\n\n"
