...
//
// Three fixed jobs, purely internal (never visible to clients):
...
$summary = ['clients_checked' => count($clients), 'cadence_alerts' => 0, 'reports_written' => 0, 'memory_curated' => 0, 'errors' => []];
