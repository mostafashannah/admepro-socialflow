...
if ($mode === 'reminders') {
    ...
    $recipients = $pdo->query("SELECT * FROM team_members WHERE status = 'active' AND role IN ('admin','accountant','account_manager','account_director','account_executive')")->fetchAll(PDO::FETCH_ASSOC);
